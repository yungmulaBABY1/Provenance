...
citation, built), MIX-01 (mixed control, built), and the compliance fixture set
(FAIL-CN-001, run at three burden levels).

FAIL-MB-008 and FAIL-MB-009 have an applied but untested per-fact repair. FAIL-MB-010 has a structurally applied MEDIA-P1 repair but no comparative rerun. FAIL-CV-003 and FAIL-CV-004 have applied or structurally validated retrieval gates without a fresh prompt rerun. FAIL-MB-016 remains proposed and untested. These six are excluded from the "Never re-observed since fix" count.
